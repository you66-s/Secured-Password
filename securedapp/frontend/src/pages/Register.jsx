            ...
            <form className=" mr-auto ml-auto">
                <fieldset className="register-form flex flex-col gap-8 p-3 ml-auto mr-auto">
                    ...
                    <div className="phone-nbr flex flex-col">
                        ...
                        <input type="number" className="border-2 p-3 rounded-[6px]"/>
                    </div>
                    <div className="email flex flex-col">
                        <label>Email</label>
                        <input type="email" className="border-2 p-3 rounded-[6px]"/>
                    </div>
                    ...
                    <button type="button" className="bg-[#2C73EB] text-white p-3 rounded-[6px]">Signup</button>
